...
\begin{enumerate}
 \item
  ...
  outlined in MES Bylaws Section \ref{co-orientation-coordinators-eligibility}.
 \item
...
\hypertarget{fireball-coordinators}{%
...
\hypertarget{information-technology-coordinators}{%
...
\hypertarget{mcmaster-engineering-competition-chairs}{%
...
\begin{enumerate}
 ...
 \item
  Enforce the MES Trailer policy (see MES Bylaws Section \ref{mes-trailer}) and
...
\begin{enumerate}
 ...
 \item
  ...
  Engineering undergraduate student body (see MES Bylaws Section \ref{frequency}).
 \item
...
\hypertarget{publications-editor}{%
...
\hypertarget{professional-development-coordinators}{%
...
\begin{enumerate}
 ...
 \item
  ...
  stationary, letterhead, business cards, and other office supplies (see MES Bylaws Section \ref{office-equipment}).
 \item
  Report to the VP Internal.
 \item
  Be a position held by a maximum of one person.
...
\hypertarget{external-conference-or-competition-chairs}{%
...
\begin{enumerate}
 ...
 \item
  ...
  MES Bylaws Section \ref{intramural-funding-policy}) and forward to the VPF.
 \item
  Report to the AVPE.
 \item
  Be a position held by a maximum of three people.
...
\hypertarget{gerald-hatch-centre-student-coordinators}{%
...
\hypertarget{mentorship-coordinators}{%
...
\hypertarget{sustainability-coordinators}{%
...
\begin{enumerate}
 ...
 \item
  Chair the FYEC Committee (see MES Bylaws Section \ref{first-year-experiential-conference-fyec-committee}).
 \item
...
\hypertarget{special-projects-coordinators}{%
...
\hypertarget{sponsorship-coordinators}{%
...
\hypertarget{appointed-positions-selection}{%
 \subsection{Appointed Positions}
 \label{appointed-positions-selection}}

\hypertarget{appointment-procedure}{%
...
\hypertarget{regular-appointed-positions}{%
...
\hypertarget{co-orientation-coordinators-eligibility}{%
 \subsubsection{Co-Orientation
  Coordinators}
...
\hypertarget{chief-returning-officer-1}{%
 \subsubsection{Chief Returning
  Officer}
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    ...
    by default. Following the bylaws as stated in MES Bylaws Section \ref{meetings-general}.\ref{CRO-chair-meetings}, the president
    ...
    their elected position. % fix this lol - need to fix this reference
  \end{enumerate}
\end{enumerate}
