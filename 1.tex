...
\input{Exec Portfolios/president.tex}
\input{Exec Portfolios/vice-president-student-life.tex}
\input{Exec Portfolios/vice-president-external-relations.tex}
\input{Exec Portfolios/vice-president-academic.tex}
\input{Exec Portfolios/vice-president-finance.tex}
\input{Exec Portfolios/vice-president-internal.tex}
\input{Exec Portfolios/vice-president-communications.tex}
...
\begin{enumerate}
 \item
  ...
  in question, to the Chief Returning Officer during the nomination period. % fix this lol broken link
 \item
...
\begin{enumerate}
 ...
 \item
  ...
  for the \$5 poster printing stipend, as outlined above in MES Bylaws Section \ref{campaign-posters}. % removed closing bracket
 \item
...
\begin{enumerate}
 \item
  ...
  member who is not seeking election. % removed extra space and comma
 \item
