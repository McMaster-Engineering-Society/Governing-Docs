...
``Welcome Week'' will herafter be referred to as ``WW''. WW is a week-long event for first year students aimed at welcoming them into the McMaster Engineering community. WW is filled with programs and events relating to community building, wellness, and McMaster Engineering traditions \& culture. %% Welcome Week (hereafter ``WW")
...
\begin{enumerate}
 \item
  The purpose of Reps is to make sure first year students have a fun and safe WW.
 \item
...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Common sense and safety questions are to be asked individually of the group members at the time of their try-out. All chosen Reps must display a commitment to abiding by the rules of Student Success Center and the Welcome Week Values and Guiding Principles.
   \item
    Upon selection, Reps must hold an MES Membership for the academic year for which selection occurs.
   \item
 ...
 \item
  ...
  \begin{enumerate}
   \item
    Rep suits are red coveralls, with the McMaster Engineering Fireball on the back.
   \item
    Reps must pay for their own suits.
   \item
    A financial need exemption to the cost of the Rep suit may be granted at the discretion of the Co-OCs.
   \item
...
\begin{enumerate}
 \item
  All Reps and first year students must respect the community and environment they are in, especially during off campus events.
 \item
  ...
  \begin{enumerate}
   ...
   \item
    ...
    \begin{enumerate}
     \item
      First years are knighted by the President with the Sword, and congratulated by the Reps.
    \end{enumerate}
   \item
    WW video
  \end{enumerate}
...
\begin{enumerate}
 ...
 \item
  The outgoing President shall present the President's Sword to the incoming President at the event.
 \item
  Council Appreciation Awards, ``Image of an Engineer'' Awards, President's Awards, Outstanding Teaching Assistant Awards, and Faculty Appreciation Awards shall be presented at the event (see MES Policy Manual Section C). % more
...
\begin{enumerate}
 ...
 \item
  Back2School Week will include the following: 
  \begin{enumerate} 
   \item 
    ClubsFest (to be organized by DoC)
   \item 
    Facult Frenzy (to be organized by Vice-President Student Life) 
   \item     
    Fresh Pub (to be organized by DoE) 
   \item 
    Lettuce
   \item    
    Hatch Open House (to be organized by DoC)     
\end{enumerate}
...
\begin{enumerate}
 \item
  Eng Pub Nights are organized by the DoE (see MES Bylaws Section \ref{director-of-events}) and the Student Life Committee (see MES Bylaws Section \ref{student-life-committee})
 \item
