...
\begin{enumerate}
 ...
 \item
  Members will approve the budget by a vote in August; this approval authorizes the Executive to make necessary expenditures outlined in the budget without further approval.
 \item
  Changes to the approved budget:

  \begin{enumerate}
   \item
    Council can amend the budget by vote during the year.
   \item
...
\begin{enumerate}
 ...
 \item
  Expenses of Groups, and individuals qualifying and approved for reimbursement will receive their funding via electronic funds transfer (EFT) to their respective bank account or via cheques written for approved expense reports.
 \item
 ...
 \item
  Payment for sponsorship funding requests may be dispensed at the discretion of the Executive.
 \item
...
\begin{enumerate}
 ...
 \item
  \$501 to \$1,500: Council majority vote
 \item
  \$500 or less: Executive majority vote
...
\begin{enumerate}
 ...
 \item
  Each Program Society will receive a standard funding in the amount of \$500 in Fall semester and again in Winter semester. No Program Society will receive annual funding in excess of \$1000. Half of the annual funding allotment for each society is to be dispensed at the first General Meeting, with the remainder dispensed at the second General Meeting, except in the case of 3. below. % clerical - randomly switching to lowercase s in Program Society, also below
 \item
 ...
 \item
  Program Societies failing to meet quorum requirements at the first General Meeting will still be eligible to receive funding (only up to the first half of their annual allotment) based upon individual motions presented to and voted upon by Council.
 \item
...
\begin{enumerate}
 ...
 \item
  ...
  \end{enumerate}
 \item
  The DoC shall review the budget proposals presented and suggest an amount to be awarded to each MES Club or Team. The Executives will review the suggested funding for each MES Club or Team and decide on the final amount that each club is to receive.
 \item
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    ...
    \begin{enumerate}
     \item
      By a vote from Council if an amount greater than \$500 is requested, in which case the head delegate from the group requesting funding must present to Council to receive the funding.
     \item
      At the discretion of the VPX if an amount less than \$500 is requested, in which case the VPX must update Council on what funding was approved.
    \end{enumerate}
   \item
   ...
   \item
    Each delegate must submit a signed Delegate Code of Conduct (Appendix F) to the VPX prior to attending the conference. Failing to do so will give the Executive the right to revoke reimbursement. % appendix
   \item
    MES funding approval (while not preferred) can be given post-event on the condition that the Executive has been made aware (in writing) of the event and that MES members are attending it. The amount given will still be determined by the above criteria.
   \item
    If Council approves funding, the group must submit receipts for all expenses being covered by the MES no later than one month after the conference or competition has concluded.
   \item
    Inappropriate or unprofessional delegate behavior gives the Executive the right to revoke reimbursement.
   \item
 ...
 \item
  ...
  \begin{enumerate}
   \item
    ...
    \begin{enumerate}
     \item
      This funding is conditional and may be revoked if the VPX fails to give a presentation to Council outlining the outcomes of the conference.
     \item
   ...
   \item
    ...
    \begin{enumerate}
     \item
      All delegates must provide a giveback after the Activity, with timeline and format up to the discretion of the VPX.
     \item
    ...
    \end{enumerate}
   \item
    The head delegate of the delegation receiving funding must fill out the MES Conference/Competition Application form (Appendix N) and submit it to the VPX.
   \item
    Each delegate must submit a signed Delegate Code of Conduct (Appendix F) to the VPX prior to attending the conference. Failing to do so will give the Executive the right to revoke reimbursement.
  \end{enumerate}
 \item
  Competitions
...
\begin{enumerate}
 \item
  ...
  \begin{enumerate}
   ...
   \item
    ...
    \begin{enumerate}
     ...
     \item
      Present to the Council the purpose of the project, details of the funds requested, and the proposed benefit to students.
    \end{enumerate}
   \item
  ...
  \end{enumerate}
 \item
  MES Groups are not eligible for this funding.
 \item
...
\begin{enumerate}
 ...
 \item
  The VPF is responsible for administering all cheques, transfers, and deposits, and must receive approval from the proper levels of Council for all payments that have not been previously granted approval by way of the budget.
...
\begin{enumerate}
 \item
  Funds held by the MES during the school year, in particular in the period between receipt of student fees in October and payment of The Centre fees in March, may be invested by the Executive in a higher return venture.
 \item
  The investment must be agreed upon unanimously by the Executive, and must involve no risk of loss of funds.
 \item
  The VPF and one of the other signing officers will carry out the investment.
 \item
  Investments will be handled through the chartered bank where the current MES external account is held, unless the Executive deems it necessary to use an alternate chartered bank or trust company.
...
\begin{enumerate}
 \item
  The MES shall maintain a flexible (no risk) investment account, the sum of which shall constitute a reserve surplus fund (The Centre Fees held by the MES do not count towards this surplus, see MES Bylaws Section \ref{investments}).
 \item
  Funds from this reserve shall be used at the discretion of the Executive as per Funding Policy (see MES Bylaws Section \ref{funding-policies}).
 \item
  MES members requesting funding from Reserve Funds must submit a proposal to the Executive.
 \item
  This fund shall not be used to finance any of the operations mentioned within the operating budget of the fiscal year. (Such as, but not limited to -- Social Events, Groups, Conferences, etc.)
 \item
...
\begin{enumerate}
 ...
 \item
  The per student MES student fee must be represented explicitly in the budget posted to the MES website upon approval by the council.
 \item
 ...
 \item
  Fees shall be increased by the Consumer Price Index upon a majority vote by the Executive.
...
\begin{enumerate}
 ...
 \item
  The macLAB Bylaws may be changed and updated without approval from the Council.
...
\begin{enumerate}
 \item
  The Executive may choose to honor any MES member by way of an award or gift.
 \item
  The purchase of these awards or gifts must have direct approval from Council before the purchase is made.
