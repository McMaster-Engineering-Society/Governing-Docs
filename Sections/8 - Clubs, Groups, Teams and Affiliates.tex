...
\begin{enumerate}
 ...
 \item
  All society presidents are members of the Club Leaders Committee (see MES Bylaws Section \ref{club-leaders-committee}).
 \item
...
\begin{enumerate}
 \item
  A Team is a non-sporting organization composed of at least 75\% McMaster undergraduate students in the Faculty of Engineering which competes at external events as representatives of McMaster.
 \item
  In order to receive Team status, Teams must have competed in at least one external event the previous year, or be approved by Council for extenuating circumstances. Otherwise, the group will be transferred to Club status.
 \item
