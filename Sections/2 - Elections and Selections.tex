...
\begin{enumerate}
  ...
  \item    
   An elected official indicates a temporary leave of absence. In this case it is up to the elected official to notify the Chief Returning Officer when they will be returning to the office. 
  \item    
   An elected official is unresponsive for a period greater than 4 weeks. 
\end{enumerate}

\subsubsection{Interim Program Representative}
\label{interim-program-rep}

\begin{enumerate}
  \item 
   In the event of a vacancy, the President of the official's Program Society shall hold the right to submit a proxy in place of the elected official. 
   \begin{enumerate}
    \item 
