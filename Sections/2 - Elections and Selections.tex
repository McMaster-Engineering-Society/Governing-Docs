...
\begin{enumerate}
  \item 
   A position is considered vacant if: 
  \begin{enumerate}
    \item 
    A Regular Election or By-election yields no elected official. 
    \item     
    An elected official leaves or is removed from office before the expiration of their term of office. 
    \item    
    An elected official indicates a temporary leave of absence. In this case it is up to the elected official to notify the Chief Returning Officer when they will be returning to the office, with the position being considered vacant for the duration of that time. 
    \item    
    An elected official is unresponsive for a period greater than 4 weeks. 
  \end{enumerate}
  \item     
   A position is no longer considered vacant if an official is elected to that position. 
\end{enumerate}
...
\begin{enumerate}
 \item
  By-elections may be held to fill a vacancy. 
 \item
...
\subsubsection{Program Representative Absence}
\label{program-rep-absence}

\begin{enumerate}
  \item 
   In the event of a vacancy, the President of the elected official's Program Society shall hold the right to submit a proxy in place of the elected official. 
   \begin{enumerate}
    \item 
     The Director of First Year Council shall hold the right to submit a proxy on behalf of the First Year Representative in the event of a vacancy of the position. 
   \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
 \item
  Should there be a vacancy in the office of MES President, the MES Council may appoint an Interim President.
 \item
