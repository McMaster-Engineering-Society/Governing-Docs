...
\begin{enumerate}
 \item
  ...
  \end{enumerate}
 \item
  All voting members of Council are equal and their rights are equal. These rights are:
 ...
 \item
  Quorum must be present at Council meetings for business to be done. Quorum shall consist of half of all voting members of the Council.
 \item
  It is the responsibility of every voting member of the Council to vote. If they do not vote, it shall be assumed that they are abstaining from the vote. Abstention is seen as recusing a  and will not count towards quorum of total votes. 
 \item
...
\begin{enumerate}
 ...
 \item
  A main motion brought toward the MES will be read to Council by the chair.
 \item
 ...
 \item
  Voting results are counted by the chair and Administrator, and the result of the main motion is announced to Council by the chair.
 \item
  A main motion shall pass if the votes in favour are counted to be half plus one of the total votes, unless specifically stated otherwise in the Constitution, Bylaws, or Policy Manual.
 \item
  All motions must be in compliance with the Constitution, Bylaws, and Policy Manual as interpreted by the chair.
...
To commit a motion sends the main motion on the floor to a committee so that it can be carefully studied and put into proper form for Council to consider, and bring back the main motion to Council with a report of their findings.
...
Limit debate is the motion by which Council can exercise special control over the debate by:
