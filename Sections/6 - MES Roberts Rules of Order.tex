...
and Council meetings. Robert's Rules of Order is a strict, but
practical system for running meetings. The Society follows its own version
...
\begin{enumerate}
 \item
  ...
  \end{enumerate}
 \item
  All voting members of the Council are equal and their rights are equal. These rights are:
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    To count votes
   \item
    To interpret the Bylaws, and Constitution
   \item
  ...
  \end{enumerate}
 \item
  The rights of MES Team members supersede the rights of individual members: Should a conflict arise between the rights of the MES and the rights of an individual member, the rights of MES shall take precedence.
 \item
  Quorum must be present at Council meetings for business to be done.
 \item
  It is the responsibility of every voting member of the Council to vote. If they do not vote, it shall be assumed that they are abstaining from the vote.
 \item
...
\begin{enumerate}
 ...
 \item
  A main motion brought to the Society will be read to the Council by the chair.
 \item
 ...
 \item
  Voting results are counted by the chair and Administrator, and the result of the main motion is announced to the Council by the chair.
 \item
  A main motion shall pass if the votes in favour are counted to be half plus one of the total votes. 
  \begin{enumerate}
    \item 
     An abstention is not a vote. 
  \end{enumerate}
 \item
  All motions must be in compliance with the Constitution and Bylaws as interpreted by the chair.
...
\begin{enumerate}
 ...
 \item
  To substitute, either by: 

  \begin{enumerate}
   \item
    striking out and inserting words.
   \item
    changing an entire motion or paragraph.
  \end{enumerate}
\end{enumerate}
...
To commit a motion sends the main motion on the floor to a committee so that it can be carefully studied and put into proper form for the Council to consider, and bring back the main motion to the Council with a report of their findings.
...
Limit debate is the motion by which the Council can exercise special control over the debate by:
