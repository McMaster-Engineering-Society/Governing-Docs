...
\begin{enumerate}
 \item
  Act as an unbiased chair for Council Meetings and General Meetings.
 \item
  Maintain order and integrity in all Council Meetings and General Meetings in accordance with the MES Robert's Rules of Order (see MES Bylaws Section \ref{mes-roberts-rules-of-order}).
 \item
 ...
 \item
  Not hold any voting position within Council.
\end{enumerate}
...
\subsubsection{Director of Academic Resources (DoAR)}
...
\subsubsection{Director of Clubs (DoC)}
...
\subsubsection{Director of Events (DoE)}
...
\subsubsection{Director of Interschool Relations (DoIR)}
\label{director-of-interschool-relations}
The Director of Interschool Relations shall: 

\begin{enumerate}
  \item 
   Chair the Delegate Selection Committee.
  \item 
   Assist the VPX with preparing delegates for external conferences.
  \item 
   Organize the Conference Info Night event informing Faculty of Engineering students of the external conferences occuring that year. 
  \item 
   Collaborate with other engineering societies on interschool events. 
  \item 
   Report to the VPX.
  \end{enumerate}
...
\begin{enumerate}
 ...
 \item
  Build and run additional EDI training for the entire Council, at the discretion of the EDI Officer.
 \item
 ...
 \item
  Be a position held by a maximum of two people.
 \item
  Not hold any other position on Council.
...
\begin{enumerate}
 ...
 \item
  Arrange for the Advertising Committee to promote sales and other campaigns.
 \item
  Report to the Vice-President Student Life
 \item
  Be a position held by a maximum of three people.
...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    The software on the MES computers is at the discretion of the Information Technology Coordinator(s) or any member of the Executive and should be used for official MES business only.
  \end{enumerate}
 \item
...
<<<<<<< HEAD
\subsubsection{Director(s) of Wellness} % Was never motioned to be changed at council :o
\label{directors-of-wellness}
The Director(s) of Wellness shall:
...
>>>>>>> 4d1994105cd3bcbb9e4584f62df93e02a057f16e
...
\begin{enumerate}
 ...
 \item
  Be responsible for recruiting/selecting members for the MEC Committee before the end of April alongside the VPX.
 \item
 ...
 \item
  Update the VPX on the MEC Committee's progress at least once per month and provide a progress report to the Executive in July, September, and November.
 \item
...
\begin{enumerate}
 ...
 \item
  Enforce the MES Trailer policy (see MES Bylaws Section \ref{mes-trailer}) and report all violations to the Executive.
 \item
...
\begin{enumerate}
 ...
 \item
  Collaborate with the Professional Development Committee and the Executive to bring forward new professional development initiatives
 \item
...
\begin{enumerate}
 ...
 \item
  Collaborate with the Leadership Development Conference Organizing Committee, and the Executive to bring forward a conference surrounding Leadership Development
 \item
  Organize event demographic and feedback collection.
 \item
  Report to the VPX
...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Executive office hours' dates and times
  \end{enumerate}
 \item
 ...
 \item
  Take and distribute the minutes and agendas of all Council and General Meetings. Council minutes shall be made available for review and continuity in a public forum within a week after the meeting has occurred
 \item
  Forward motions for funding to the VPF as they are received
 \item
  Be responsible for sending out Council meeting agendas ahead of each Council and General Meeting
 \item
  Be responsible for ensuring the public accessibility of Council meeting minutes on the MES website within one week of the meeting.
 \item
  Record attendance at Council meetings and enforce the Attendance Policy (see MES Bylaws Section \ref{attendance}).
 \item
...
\begin{enumerate}
 ...
 \item
  Complete other design projects as requested by the Executive.
 \item
 ...
 \item
  Create promotional videos for advertisement campaigns as requested by the Executive.
 \item
  Report to the VPC.
 \item
...
the Executive to run an Engineering Students Societies' Council of
Ontario (ESSCO) or Canadian Federation of Engineering Students (CFES)
Activity. All chairs shall hold appointed positions on the MES.
...
\begin{enumerate}
 ...
 \item
  Assist Vice-President Student Life with the execution of Faculty Frenzy. 
 \item
...
\begin{enumerate}
 ...
 \item
  Work with the Vice-President Student Life to improve the sustainability of MES events.
 \item
...
\begin{enumerate}
 \item
  Work with the Chief Returning Officer to recruit and run first year elections in September.
 \item
...
\subsection{Appointed Positions Selection}
...
\begin{enumerate}
 ...
 \item
  The Executive, Directors, and in some cases, the MES Team member currently holding the position sought, will review the applications, and applicants will be contacted for interviews during the following week. Interviews and selections will be conducted by the Executive and in some cases, the Directors and the outgoing position holder.
 \item
...
\begin{enumerate}
 ...
 \item
  Phoenix Formal Coordinator(s) % Not motioned
 \item
 ...
 \item
  Director(s) of Sports % not motioned
 \item
  Director(s) of Sustainability % not motioned
 \item
  Trailer Coordinator(s)
 \item
  Website Coordinator(s)
 \item
  Director(s) of Wellness % not motioned
 \item
...
\begin{enumerate}
 ...
 \item
  The MEC Chair(s) shall be appointed before the end of May.
\end{enumerate}
% \end{document}
