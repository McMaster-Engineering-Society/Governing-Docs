...
\begin{enumerate}
 ...
 \item 
  Ensure that the written content of the Plumbline is properly displayed and easy to navigate and read.
 \item 
  Ensure that all imagery used is appropiate (see MES Bylaws \ref(editorial-policy)) and relevant to the related article.
 \item 
  Report to the Plumbline Editor(s)
 \item 
  Be a position held by a number of individuals decided at the discretion of the VPC, Publications Editor, and Plumbline Editors.
\end{enumerate}
