...
The Executive shall consist of the following positions. One person shall occupy each position.
...
\begin{enumerate}
 ...
 \item
  To act as an advisory board to Council on the effects of Council's policy decisions on the day-to-day operations of the MES.
 \item
  To perform the functions of Council during the summer, subject to any restrictions placed on it by Council.
 \item
  In case of an emergency situation where Council is unable to meet, the Executive may make an interim decision, although any policy decisions shall be subject to ratification at the next Council meeting.
 \item
...
\begin{enumerate}
 \item
  Review the MES budget prepared by the VPF for final recommendations to Council.
 \item
 ...
 \item
  Be accountable and transparent for all its actions to Council and to the general membership at each General Meeting.
 \item
...
\subsection{Directors} % This should be moved to appointed
\label{directors}
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    \begin{enumerate}
     \item
      The Engineering 1 Representative also serves and is a voting member on Council.
    \end{enumerate}
   \item
