...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   \item
    All proposals must have established the terms of the fund and the criterion by which candidates will be judged. A statement of the terms of the award must be added to the Policy Manual. % clerical - soon to be nonexistent
   \item
    The method of administering the awards must be decided upon prior to passage of the award.
  \end{enumerate}
 \item
  At the discretion of the Executive, awards may include an honorarium, funded by the MES, no greater than \$200 per award.
 \item
  The Council must approve awards funded by an external source, through a two thirds majority vote at a Council meeting.
\end{enumerate}
...
\begin{enumerate}
 \item
  ...
  \begin{enumerate}
   \item
    Up to three Team Appreciation Awards shall be given out each year at Fireball for exceptional work on the MES Team.
   \item
    Recipients must be a member of the MES Team, and may be either appointed or elected.
   \item
    Executive members are ineligible for this award.
   \item
    The Executive shall choose the recipients for this award..
  \end{enumerate}
 \item
 ...
 \item
  ...
  \begin{enumerate}
   \item
    Up to two President's Awards shall be given out each year at Fireball.
   \item
    The President's Award is given to an MES member for their exceptional contributions to the MES.
   \item
