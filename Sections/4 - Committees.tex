...
\begin{enumerate}
 ...
 \item
  The Advertising Committee is responsible for ensuring advertising campaigns are made for each event as requested by an MES position holder, or any external group sponsored by or collaborating with the MES.
 \item
 ...
 \item
  ...
  \end{enumerate}
 \item
  The Committee is responsible for ensuring that media content (such as flyers, posters, posts, stories, and videos) are created, in coordination with the brand, for all MES events.
...
\begin{enumerate}
 ...
 \item
  The Editorial Review Committee must review and unanimously approve of all material being considered for all MES publications in accordance with the editorial policies of the MES (see MES Bylaws 11.1).
 \item
...
\begin{enumerate}
 \item
  The Director of Events shall chair the Bus Monitor Committee.
 \item
 ...
 \item
  Online and in-person training for bus monitors will be provided.
 \item
...
\begin{enumerate} 
  ...
  \item    
   ...
   \end{enumerate}    
  \item    
   The Infrastructure Technology Committee is responsible for ensuring the MES Website, Hatch Booking System, and all other infrastructure technology are up to date and functional. 
\end{enumerate}