...
\begin{enumerate}
 ...
 \item
  To provide information to the McMaster Engineering students. 
 \item
  To provide news and feature coverage of campus and/or McMaster Engineering related events.
 \item
...
\begin{enumerate}
 \item
  Any material submitted to these publications is considered for publication if, in the opinion of the Editor(s) or the Editorial Review Committee, it is:

  \begin{enumerate}
   \item
    A paid advertisement or classified listing.
   \item
    A feature dealing with McMaster Engineering-related issues.
   \item
    A message from the MES Team or Executive.
   \item
    An editorial or letter from the editors.
   \item
    A feature coverage of a campus and/or McMaster Engineering-related event.
   \item
...
\label{plumbline}
The Plumbline is the MES's humorous student
publication.
...
\begin{enumerate}
 \item
  ...
  \begin{enumerate}
   \item
    Printed in magazine format, it may contain student pictures, jokes, etc. selected by the Plumbline Editor(s), Writer(s) and Designer(s).
   \item
    Issue publication and distribution should be scheduled at least once a semester (for fall and winter semesters), pending time and budget constraints.
   \item
    The number of copies printed is left at the discretion of the Plumbline Editor(s), Publications Editor, and the VPC. 
   \item
    Distribution should occur via the MES website, social media, DW Lounge, Junction Lounge, and The Drain. 
   \item
   ...
   \item
    The Plumbline can only be sent for print once the Plumbline Editor(s) have received a response from the majority of the Editorial Review Committee.
  \end{enumerate}
 \item
  Disclaimer Policy
  ...
  \begin{enumerate}
   \item
    The contents of the magazine must include a disclaimer that explains to all readers that the articles are for entertainment purposes only, and are not intended to offend any person or party.
   \item
...
\label{frequency}
The Frequency is the MES's serious student publication. Inappropriate pictures such as pictures of
...
\begin{enumerate}
 \item
  ...
  \begin{enumerate}
   \item
    Printed in magazine format, containing academic, club, research, advice, etc. selected by the Frequency Editor(s), Writer(s) and Designer(s). 
   \item     
    Issue publication and distribution should be scheduled at least once a semester (for fall and winter semesters), pending time and budget constraints. 
   \item
   ...
   \item
    Distribution should occur via the MES website, social media, DW Lounge, Junction Lounge, and The Drain.
   \item
    The entire contents of each Frequency must be reviewed by the Editorial Review Committee to ensure the contents strictly fall within the guidelines of the Editorial Policy (see MES Bylaws Section 4.4.5 and 11.1.3). 
...
year McMaster Engineering students with the intention of introducing them to
...
\begin{enumerate}
 \item
  ...
  \begin{enumerate}
   ...
   \item
    The Handbook Editor(s), Publications Editor, VPC, VPF, and the President shall decide the number of Handbooks to be printed. 
   \item
    Extra copies shall be distributed to upper level students.
   \item     
    The entire contents of the Engineering Handbook must be reviewed by the Editorial Review Committee to ensure the contents strictly fall within the guidelines of the Editorial Policy (see MES Bylaws Section 4.4.5 and 11.1.3). 
  \end{enumerate}
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Two back-toback laminated pages showcasing a campus map 
   \item     
    MES Team email and position list
   \item
    MES Executive introductions
   \item
    WW Team introductions 
   \item    
    Handbook Editor(s) introductions   
   \item    
    Class schedule for each term
   \item
    Monthly calendars with MES events printed on appropriate dates
   \item
    List and description of MES committees and sign up procedures
   \item
    Page for notable McMaster Engineering and university contacts 
   \item
    Jokes, poems, drawings, and engineering traditions
   \item
    Sponsored advertisements
   \item
    Introduction to the MES
   \item
    List and description of all MES Fireball Awards
   \item    
    MES affiliate and ratified club introductions 
  \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
 \item
  The Website Coordinator(s) is responsible for creating and maintaining the website along with resolving technical issues surrounding the website and ensuring website uptime.
 \item
  The Infrastructure Technology Manager(s) are responsible for resolving technical issues surrounding the website and ensuring website uptime.
 \item
  The language throughout the website should be clean, easily readable and understandable, and appropriate.
 \item
 ...
 \item
  The website should have an up to date repository of all MES documents (Constitution, Bylaws, meeting minutes, Plumbline, Frequency, Handbook, Reports, etc.) and event news.
 \item
  Website editing access will be limited to the President, MES Executive, Website Coordinator(s), and Infrastructure Technology Manager(s) and Infrastructure Technology Committee. Further access may be granted at the discretion of the VPI.
...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   \item
    Each coupon will have a value of \$13, up to a limit of 7 per academic year. 
   \item
    Tutors are able to choose the rate that they charge students. 
   \item
    Online Coupons can only be redeemed by McMaster Undergraduate students in Faculty of Engineering for personal use.
  \end{enumerate}
 \item
  Tutors
  ...
  \begin{enumerate}
   ...
   \item
    Must have received a grade of 9.0 or higher in a course to be able to qualify to be a tutor for that course
   \item
...
the opportunity to borrow textbooks for free. The MES Textbook Library shall be run out of the
...
\begin{enumerate}
 ...
 \item
  Academic workshops must be intended for helping with the preparation for course-related assessments (e.g. exams, midterms, practicums). 
 \item 
  All Program societies shall submit for prior approval from the DoAR, at least 1 week prior to any eligible academic workshops which they would request funding.
 \item
