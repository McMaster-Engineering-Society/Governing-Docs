...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   \item
    The VPC must be contacted and informed of the specific concerns and problems.
   \item
    All valid complaints will receive a response within two weeks and an invitation to meet with the President and the Editorial Review Committee.
   \item
    If the situation is not resolved at this point, a meeting will be set with the Dean of Engineering, the President, and the Editorial Review Committee to discuss appropriate actions.
   \item
...
MES, Clubs, Teams, and Affiliates clubs and teams. Material from other groups can be
...
\begin{enumerate}
 ...
 \item
  Website editing access will be limited to the President, Executive, Website Coordinator(s), and Information Technology Coordinator(s). Further access may be granted at the discretion of the VPC.
...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Students are permitted to eat in the DW Lounge, but are responsible for the clean up of their own food.
   \item
...
\begin{enumerate}
 ...
 \item
  Drain Coordinator(s)
 \item
  Co-OCs (From April of each year until 2 weeks after Welcome Week) % clerical
 \item
<<<<<<< HEAD
...
service will be strictly limited to Groups. Item sales are
...
\begin{enumerate}
 \item
  The MES office is secured with a keycard lock for which only the above MES members will be given keycard access to.
 \item
  It is the Responsibility of the VPI to assign and revoke keycard access to the MES Office.
 \item
  Under special circumstances, other MES members who request use of the office for MES activities may also be issued provisional access by one of the members listed in the MES Policy Manual Section B.6.1.
 \item
  Any MES members currently serving on Engineering Student Societies' Council of Ontario or Canadian Federation of Engineering Students may be given limited access for business of their position only. This request must be approved by the Executive.
 \item
...
recognized Group or MES member and shall be administered by the
...
from the Trailer Coordinator(s) and the Executive.
...
\begin{enumerate}
 ...
 \item
  The group booking the MES Trailer is responsible for cleaning up any mess left in or on the MES Trailer. Failure to do so may result in a \$50 fine, at the discretion of the Trailer Coordinator(s) and the Executive.
 \item
...
\begin{enumerate}
 ...
 \item
  No additional copies of the MES Trailer keys may be made, except by the Trailer Coordinator(s) with written permission from the Executive. If illegal copies are found, the offending party will be subject to loss of privileges or other punishment as recommended by the Executive.
...
\begin{enumerate}
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Reviewing Coverall Event applications
   \item
    Reviewing Coverall applications
   \item
    Rescinding Coverall Event approval if necessary
   \item
  ...
  \end{enumerate}
 \item
  The Coverall Oversight Committee will be chaired by the VPX.
 \item
...
\begin{enumerate}
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Maintaining and updating the Coverall Event, and Coverall Application forms.
   \item
   ...
   \item
    Reviewing the eligibility of Coverall Sponsor applicants, and acting as the Coverall Sponsor in the case a Coverall Sponsor applies to purchase Coveralls for their own Coverall Event.
   \item
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item 
    Executing responsibilities as delegated by the VPX.
  \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
 ...
 \item
  Student leaders in MES Groups, Committees, and Affiliates may act as a Coverall Sponsor.
 \item
...
\begin{enumerate}
 ...
 \item
  Once approved, the Coverall Applicant will be contacted by the VPX to coordinate sizing, pick-up, and payment.
 \item
